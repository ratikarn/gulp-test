...
/*#__PURE__*/
function (_User) {
  _inherits(VipUser, _User);

  function VipUser() {
    _classCallCheck(this, VipUser);

    return _possibleConstructorReturn(this, _getPrototypeOf(VipUser).call(this));
  }
...
vipUser.showUser(); // let a = new User ();
